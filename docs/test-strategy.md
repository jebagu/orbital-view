...
- SceneKit review-app fog behavior exposes a nonlinear atmospheric depth ramp that reduces rear alpha, rear emission, speaker/source color contrast, label opacity, and Ribbed Speaker Sphere material/cutaway visibility while preserving selected speaker readability and camera-only material-skip cadence
